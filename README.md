...
The code that's generated by this annotation processor 
doesn't add any runtime dependencies to your project.
When used in a maven pom, it should have `provided` scope:
