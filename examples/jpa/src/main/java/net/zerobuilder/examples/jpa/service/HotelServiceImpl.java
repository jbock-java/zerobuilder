...
import net.zerobuilder.examples.jpa.domain.Rating;
import net.zerobuilder.examples.jpa.domain.RatingCount;
import net.zerobuilder.examples.jpa.domain.Review;
import net.zerobuilder.examples.jpa.domain.ReviewDetails;
...
@Transactional class HotelServiceImpl implements HotelService {
