  ...
  public void instance() {
    ...
    JavaFileObject expected =
        forSourceLines("cube.ThrowBuilders",
            ...
            "    VoidBuilderImpl voidBuilderImpl = new VoidBuilderImpl();",
            "    return voidBuilderImpl;",
            "  }",
            "",
            "  static final class VoidBuilderImpl implements VoidBuilder.Message {",
            "    private VoidBuilderImpl() {}",
