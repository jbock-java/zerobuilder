  ...
  public void simpleCube() {
    ...
    JavaFileObject expected =
        forSourceLines("cube.CubeBuilders",
            ...
            "  }",
            "",
            "  private final CuboidBuilder.UpdaterImpl cuboidUpdater = new CuboidBuilder.UpdaterImpl();",
            "  private final CuboidBuilder.StepsImpl cuboidSteps = new CuboidBuilder.StepsImpl();",
            "  private CubeBuilders() {}",
            "",
            "  static CuboidBuilder.Contract.Height cuboidBuilder() {",
            "    CuboidBuilder.StepsImpl stepsImpl = INSTANCE.get().cuboidSteps;",
            "    return stepsImpl;",
            "  }",
            "",
