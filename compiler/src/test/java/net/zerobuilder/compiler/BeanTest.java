  ...
  public void businessTest() {
    ...
    JavaFileObject expected =
        forSourceLines("beans.BusinessAnalystBuilders",
            ...
            "    }",
            "",
            "    public BusinessAnalystUpdater notes(Iterable<String> notes) {",
            ...
            "    }",
            "",
            "    @Override public BusinessAnalyst notes(Iterable<String> notes) {",
            "      for (String string : notes) {",
            "        this.businessAnalyst.getNotes().add(string);",
            "      }",
            ...
            "      BusinessAnalyst notes(Iterable<String> notes);",
