  ...
  public void simpleCube() {
    ...
    JavaFileObject expected =
        forSourceLines("cube.CubeBuilders",
            ...
            "    }",
            "    CuboidUpdater updater = refs++ == 0 ? INSTANCE.get().cuboidUpdater : new CuboidUpdater();",
            ...
            "    CuboidBuilderImpl cuboidBuilderImpl = refs++ == 0 ? INSTANCE.get().cuboidBuilderImpl : new CuboidBuilderImpl();",
            ...
            "      return this;",
            "    }",
            "    public Cube done() { refs--; return Cube.create( height, length, width ); }",
            "  }",
            "",
