...
final class Generator {
  ...
  static BuilderMethod goalMethod(AbstractRegularDetails details, ProjectedRegularGoalDescription description) {
    return switch (details) {
      case DtoGoalDetails.ConstructorGoalDetails constructor -> normalGoalMethod.apply(constructor, description);
      case DtoGoalDetails.StaticMethodGoalDetails staticMethod -> normalGoalMethod.apply(staticMethod, description);
      case DtoGoalDetails.InstanceMethodGoalDetails instanceMethod -> InstanceWorld.instanceGoalMethod(instanceMethod, description);
    };
  }
