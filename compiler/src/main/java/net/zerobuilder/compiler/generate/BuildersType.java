...
public final class BuildersType {
  ...
  private BuildersType(boolean recycle, ClassName type, ClassName generatedType, FieldSpec field) {
  ...
  public static BuildersType createBuilderContext(TypeElement buildElement) {
    ...
    return new BuildersType(nogc, annotatedType, generatedType, field);
  }
