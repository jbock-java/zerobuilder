...
With this, the generated code will reuse builder instance if possible.

<em>Note 1</em>: The `@Recycle` annotation is not allowed and will raise a compile error,
if `Doo` has any type parameters (such as `Doo<E>`.).

<em>Note 2</em>: The code generated by `@Recycle` uses `ThreadLocal`, which can cause
